...
- **tests** — specs, fixtures, and mocks: `**/__tests__/**`, `**/*.test.*`, `**/*_test.*`, `**/spec/**`, `**/mocks/**`, `**/test_*.py`, `**/*Test.*`, `**/*_unittest.*`, `**/testdata/**`, …
- **generated** — machine-written and committed: lockfiles, `**/dist/**`, `**/build/**`, `**/target/**`, `**/obj/**`, `**/node_modules/**`, `**/vendor/**`, `**/coverage/**`, `**/*.pb.go`, `**/*_pb2.py`, `**/*.pb.cc`, `**/gradle/wrapper/**`, `**/Pods/**`, `**/*.min.js`, …
- **docs** — prose: `**/*.md`, `**/*.rst`, `**/*.adoc`, `**/*.txt` (bar the ones config claims), `**/docs/**`, `LICENSE*`
- **config** — machine-read settings and build definitions: `**/*.json`, `**/*.yml`, `**/*.toml`, `**/*.ini`, `**/*.cfg`, `**/requirements*.txt`, `**/robots.txt`, `**/.github/**`, and the build and manifest files a toolchain reads — `**/Dockerfile*`, `**/Makefile*`, `**/CMakeLists.txt`, `**/pom.xml`, `**/*.gradle*`, `**/go.mod`, `**/*.csproj`, `**/Gemfile`, `**/Package.swift`, `**/mix.exs`, `**/setup.py`, `**/*.tfvars`, …
- **source** — the code the change is actually about: everything matching none of the above.

A build definition counts as **config** rather than source — a `Makefile`, `CMakeLists.txt` or `build.gradle` describes how to build the thing rather than being the thing. Languages covered by name: JavaScript/TypeScript, Python, Java/Kotlin, C/C++, C#, Go, Rust, Ruby, Swift/Objective-C, Dart, Elixir, PHP, and Terraform, plus the conventions shared across all of them.
