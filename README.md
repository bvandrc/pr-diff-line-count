...
- **docs** — prose: `**/*.md`, `**/*.rst`, `**/*.adoc`, `**/*.txt`, `**/docs/**`, `LICENSE*`
- **config** — machine-read settings: `**/*.json`, `**/*.yml`, `**/*.toml`, `**/*.ini`, `**/*.cfg`, `**/requirements*.txt`, `**/CMakeLists.txt`, `**/setup.py`, `**/.github/**`, `**/Dockerfile*`, `**/*.tfvars`
